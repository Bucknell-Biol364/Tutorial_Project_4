...
For this example, let's use the square root transformation. You will want to name the new vector "sqrtbodywt" and instead of using the "log" transformation you will use "sqrt". Then you will use the new vector in the simple.eda and the shapiro.test.
...
*trying to format a different t-test*
